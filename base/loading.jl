...
precompile(include_package_for_output, (String,Vector{String},Vector{String},Vector{String},typeof(_concrete_dependencies),NTuple{2,UInt64},Nothing))
precompile(include_package_for_output, (String,Vector{String},Vector{String},Vector{String},typeof(_concrete_dependencies),NTuple{2,UInt64},String))
...
function create_expr_cache(input::String, output::String, concrete_deps::typeof(_concrete_dependencies), uuid::Union{Nothing,UUID})
    ...
    io = open(pipeline(`$(julia_cmd()) -O0
                       ...
                       --eval $code`, stderr=stderr),
              "w", stdout)
    return io
end

precompile(create_expr_cache, (String, String, typeof(_concrete_dependencies), Nothing))
precompile(create_expr_cache, (String, String, typeof(_concrete_dependencies), UUID))
